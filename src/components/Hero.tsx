  ...
  return (
    <section ref={ref} className="min-h-screen relative overflow-hidden bg-gradient-primary flex items-center justify-center">
      ...
      <div className="absolute inset-0">
        <motion.div
          className="absolute top-20 left-10 w-20 h-20 rounded-full bg-glass-white blur-sm"
          animate={{ y: [0, -20, 0], opacity: [0.3, 0.6, 0.3] }}
          transition={{ duration: 4, repeat: Infinity }}
        />
        <motion.div
          className="absolute bottom-20 right-10 w-32 h-32 rounded-full bg-glass-dark blur-md"
          animate={{ y: [0, 20, 0], opacity: [0.2, 0.5, 0.2] }}
          transition={{ duration: 6, repeat: Infinity, delay: 1 }}
        />
        <motion.div
          className="absolute top-1/2 left-1/4 w-16 h-16 rounded-full bg-glass-white blur-lg"
